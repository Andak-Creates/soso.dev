    ...
    >
      {images.map((img, index) => (
        <div
          ...
          className={`${
            img.containerClass
          } bg-white p-2 rounded-lg relative shrink-0 cursor-grab active:cursor-grabbing transition-all duration-300 ${
            index === 1 ? "lg:w-[230px]" : ""
          }`}
          style={{
...
export default ThreeDragImages;
